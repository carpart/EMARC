...
define ("DBFFIELD_TYPE_CURRENCY","Y");	// Y = Currency Treating this as a float
...
class XBaseRecord {
	...
	function getCurrency($columnObj) {
	    if ($columnObj->getType()!=DBFFIELD_TYPE_CURRENCY) trigger_error ($columnObj->getName()." is not a Currency column", E_USER_ERROR);
        return $this->forceGetString($columnObj);
    }
    ...
    function setObject($columnObj,$value) {
        switch ($columnObj->getType()) {
            ...
            case DBFFIELD_TYPE_CURRENCY : $this->setCurrency($columnObj,$value); return;
    ...
    function setCurrency($columnObj,$value) {
	    if ($columnObj->getType()!=DBFFIELD_TYPE_CURRENCY) trigger_error ($columnObj->getName()." is not a Curency column", E_USER_ERROR);
        return $this->forceSetString($columnObj,$value);
    }
    /**
     * -------------------------------------------------------------------------
